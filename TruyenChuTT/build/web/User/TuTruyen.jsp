...
<head>
    ...
    <title>Tủ Truyện - TruyenChuTT</title>
...
<body>
    <div class="container">
        <div class="header-card">
            <h1 class="text-white mb-3"><i class="fas fa-bookmark"></i> Tủ Truyện Của Tôi</h1>
        ...
        <c:choose>
            <c:when test="${empty danhSach}">
                <div class="empty-state">
                    ...
                    <h3 class="text-white">Chưa có truyện nào trong tủ</h3>
                            ...
                            <div class="story-card">
                                <a href="${pageContext.request.contextPath}/story?id=${item.truyen.id}" class="text-decoration-none">
                                    ...
                                    <p class="text-white-50 small mb-3">
                                        <i class="fas fa-calendar"></i> ${item.ngayLuuFormatted}
                                    </p>
                                </a>
                                <div class="d-flex gap-2">
                                    ...
                                    <button onclick="removeFromLibrary(${item.truyen.id})" 
    ...
    <script>
        function removeFromLibrary(truyenId) {
            if (!confirm('Bạn có chắc muốn xóa truyện này khỏi tủ?')) {
                return;
            }
            
            fetch('${pageContext.request.contextPath}/tutruyen/remove', {
                method: 'POST',
                headers: {
